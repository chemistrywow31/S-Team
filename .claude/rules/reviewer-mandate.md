...
The Process Reviewer must have its own agent .md file in a dedicated review group folder (e.g., `agents/review/`). It must not share a group folder with the execution agents whose work it reviews.
...
- Process Reviewer .md missing the six evaluation dimensions → Violation
- Process Reviewer .md missing the retrospective report format → Violation
