...
Child of `rules/layout-overflow-prevention.md` (the umbrella). Applies to reveal.js HTML presentations. You must also comply with the umbrella's cross-format mandates and enforcement.
