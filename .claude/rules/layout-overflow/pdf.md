...
Child of `rules/layout-overflow-prevention.md` (the umbrella). Applies to reportlab-generated PDF documents. You must also comply with the umbrella's cross-format mandates and enforcement.
