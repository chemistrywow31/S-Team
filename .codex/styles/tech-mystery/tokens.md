...
(`min-height` / `overflow` required by `.codex/rules/responsive-auto-fit.md` — do not remove.)
...
This block is read by `.codex/rules/visual-effects-standard.md` to determine which effects are required, allowed, or forbidden for this style.
