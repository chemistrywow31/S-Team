...
Child of `.codex/rules/layout-overflow-prevention.md` (the umbrella). Applies to PptxGenJS-generated PPTX presentations. You must also comply with the umbrella's cross-format mandates and enforcement.
